...
version = "0.1.0"
license_ = "Apache 2.0"
description = "Utility package for qiskit and physicsfront-qiskit"
long_description = "This package provides module physicsfront.mqca, developed for teaching quantum computing."
